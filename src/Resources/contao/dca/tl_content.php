...
$GLOBALS['TL_DCA']['tl_content']['palettes']['mvo_facebook_post_list'] =
    '{type_legend},type,headline;mvo_facebook_numberOfPosts;{image_legend},size,fullsize;{expert_legend:hide},cssID;';

$GLOBALS['TL_DCA']['tl_content']['palettes']['mvo_facebook_event_list'] =
    '{type_legend},type,headline;{image_legend},size,fullsize;{expert_legend:hide},cssID;';
